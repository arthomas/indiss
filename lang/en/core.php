 ...
 */
    ...
    /*Strings used in the backend index page adm* */
    $_LANG["admLayoutAndRealization"]       = "Layout and realization";
    $_LANG["admIndissIsFreeSoftware"]       = "INDISS is free software under the GNU GPLv3";
    $_LANG["admPageCreatedIn"]              = "Page was created in: %s sec"; //%s: time taken, formatted as %6.4f
