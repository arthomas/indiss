...
<head>
    ...
    function checkDBdata() {
        ...
        if (document.getElementById('dbhost').value == "") {
            ...
            document.getElementById('dbhostnote').firstChild.nodeValue = "Field cannot be empty.";
            r = false;
        } else {
        ...
        if (document.getElementById('dbname').value == "") {
            ...
            document.getElementById('dbnamenote').firstChild.nodeValue = "Field cannot be empty.";
            r = false;
        } else {
        ...
        if (document.getElementById('dbuser').value == "") {
            ...
            document.getElementById('dbusernote').firstChild.nodeValue = "Field cannot be empty.";
            r = false;
        } else {
        ...
        if (document.getElementById('dbpass1').value != document.getElementById('dbpass2').value) {
            ...
            document.getElementById('dbpassnote').firstChild.nodeValue = "Passwords do not match.";
            r = false;
        } else {
            ...
            <div id="enterdata">
                <table summary="" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                            <td>Database type:</td>
                            <td>MySQL<div class="small">Note: At the moment, only MySQL databases are supported.</div></td>
                        </tr>
                        <tr id="dbhostrow">
                            <td>Database host:</td>
                            <td><input type="text" name="dbhost" id="dbhost" <?php if ( isset( $_POST["dbhost"] ) ) echo "value=\"" . $_POST["dbhost"] . "\" ";?>/> <span id="dbhostnote" style="color: red;" class="small">&nbsp;</span><div class="small">This is probably <i>localhost</i>.</div></td>
                        </tr>
                        <tr id="dbnamerow">
                            <td>Database:</td>
                        ...
                        <tr id="dbpass1row">
                            <td style="padding-bottom: 0;">Password:</td>
                        ...
                        <tr id="dbpass2row">
                            <td style="padding-top: 2px;">Confirm password:</td>
                ...
                <div id="dbiframecontainer" style="padding-top: 20px;">
                    Note: The database connection will be tested in the last installation step. Should there be problems with the data you entered, you will be redirected back here to correct it.
                </div>
            </div>
            <div>
                <table id="buttonbar" summary="" cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                        <tr>
                            ...
                            <td id="rightbox">
                                <input type="button" name="next" value="<?php lang_echo("genNext"); ?> >" id="nextbutton" onclick="checkDBdata();" />
                            </td>
                        </tr>
                    </tbody>
                </table>
