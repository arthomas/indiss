 ...
 */
    ...
    $_LANG["1PageTitle"]                    = "INDISS Installation - Step 1: Language selection";
    $_LANG["1WelcomeMsg"]                   = "Welcome to the INDISS installation script!";
    $_LANG["1PlsSelectLang"]                = "Please select the language for this installation:";
    $_LANG["1UseAsDefaultLang"]             = "Use this language as default language for INDISS as well";
    
    $_LANG["2PageTitle"]                    = "INDISS Installation - Step 2: Introduction and license";
    $_LANG["2ThisWizard"]                   = "This wizard will guide you through the installation of INDISS. It will ask you to enter some default settings and an administrator password. Once you have completed entering all necessary data, the script will create the required database tables and save all settings.";
    ...
    $_LANG["2LicenseDisplay"]               = "In the following box, a full copy of the GNU General Public License v3 will be displayed. By installing and using INDISS, you agree to this license, even if you by some means skip this step or the whole installation script.";
    $_LANG["2OrigDocAt"]                    = "The original document can be viewed at";
    
    $_LANG["3PageTitle"]                    = "INDISS Installation - Step 3: Database setup";
    $_LANG["3PleaseEnterData"]              = "Please enter the data required to access the database below.";
    $_LANG["3TablePermission"]              = "The used database must either already contain a table named 'indiss' (no quotes) or the account used to access the database must have permission to create new tables.";
    $_LANG["3SecurityNote"]                 = "<b>Important</b>: Using the 'root' account to access the database is highly discouraged. Please be aware that the username, database name <b>and password</b> will be saved as <b>unencrypted text</b> on the file system. Therefore, please make sure that no unauthorized access to the INDISS folder is possible.";
    ...
    $_LANG["4JSResEmpty"]                   = "Please enter a screen resolution";
    $_LANG["4JSResOnlyNumbers"]             = "Please only enter numbers.";
    ...
    $_LANG["6PageTitle"]                    = "INDISS Installation - Step 6: Installation summary";
